...
int armstrong(int low, int high)
 {
   ...
   int __SEQ_STATUS_temp2_14 = 0;
   int __SEQ_STATUS_temp2_15 = 0;
   int __SEQ_STATUS_temp2_16 = 0;
   int __SEQ_STATUS_temp2_17 = 0;
   int __SEQ_STATUS_remainder_0_18 = 0;
   int __SEQ_STATUS_n_19 = 0;
   int __SEQ_STATUS_n_20 = 0;
   int __SEQ_STATUS_n_21 = 0;
   int __SEQ_STATUS_result_22 = 0;
   ...
   while (1) {
     ...
     __SEQ_STATUS_temp2_14 = 0;
     __SEQ_STATUS_temp2_15 = 0;
     __SEQ_STATUS_temp2_16 = 0;
     __SEQ_STATUS_temp2_17 = 0;
     temp2 = i;
     __SEQ_STATUS_temp2_14 = 1;
     __SEQ_STATUS_temp2_16 = 1;
     ...
     skip:
     while (1) {
       pc_label(__SEQ_STATUS_temp2_14 == 1,14,"ADC");
       pc_label(__SEQ_STATUS_temp2_15 == 1,15,"ADC");
       if (! (temp2 != 0)) break;
       {
         double tmp;
         pc_label(__SEQ_STATUS_temp2_16 == 1,16,"ADC");
         pc_label(__SEQ_STATUS_temp2_17 == 1,17,"ADC");
         __SEQ_STATUS_remainder_0_18 = 0;
         remainder_0 = temp2 % 10;
         __SEQ_STATUS_remainder_0_18 = 1;
         pc_label(__SEQ_STATUS_remainder_0_18 == 1,18,"ADC");
         pc_label(__SEQ_STATUS_n_19 == 1,19,"ADC");
         pc_label(__SEQ_STATUS_n_20 == 1,20,"ADC");
         pc_label(__SEQ_STATUS_n_21 == 1,21,"ADC");
         tmp = pow((double)remainder_0,(double)n);
         pc_label(__SEQ_STATUS_result_22 == 1,22,"ADC");
         pc_label(__SEQ_STATUS_result_23 == 1,23,"ADC");
         pc_label(__SEQ_STATUS_result_24 == 1,24,"ADC");
         __SEQ_STATUS_result_22 = 0;
