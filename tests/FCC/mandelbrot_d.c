/* run.config
   EXECNOW: LOG @PTEST_NAME@_labels.c LOG @PTEST_NAME@_output.log LOG @PTEST_NAME@_labels.labels LOG @PTEST_NAME@_labels.hyperlabels @frama-c@ -lannot=FCC @PTEST_DIR@/@PTEST_NAME@.c -lannot-debug 3 -lannot-o @PTEST_DIR@/result/@PTEST_NAME@_labels.c > @PTEST_DIR@/result/@PTEST_NAME@_output.log
 */


/* Mandelbrot avec simulation de flottant */
