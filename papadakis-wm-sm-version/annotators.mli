...
type annotation = int * string * Cil_types.stmt * Cil_types.location * Cil_types.exp * Cil_types.exp * Cil_types.stmt * Cil_types.stmt
type annotator
...
module RegisterStrong (A : ANNOTATOR_Strong) : S
...
val strongmutation : string list -> Cil_types.file -> annotation list
